...
g++ -g -I include -I src -std=c++17 src/test/tc_xmap.cpp src/test/tc_heap.cpp src/test/tc_compressor.cpp src/main.cpp src/test/tc_dlinkedlist.cpp src/test/tc_xarraylist.cpp src/test/tc_inventory.cpp -o main